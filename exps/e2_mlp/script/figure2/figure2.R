...
## ----functions----------------------------------------------------------------
#Functions
source("exps/e2_mlp/script/figure2/tree_tools.R")
source("exps/e2_mlp/script/figure2/mincBuildArray.R")
source("exps/e2_mlp/script/figure2/processing_tools.R")
source("exps/e2_mlp/script/figure2/buildSimilarityMatrix.R")
...
load("data/mouse_human/data.ign/TreeLabelsReordered.RData")

#Import MICe data tree
load("data/mouse_human/data.ign/MouseExpressionTree_DSURQE.RData")
...
load("data/mouse_human/data.ign/HumanExpressionTree.RData")
...
## ----results2-fig2-panelA-network-nodes---------------------------------------
# Parameters
...
## ----results2-fig2-panelA-network-ellipses------------------------------------
...
## ----results2-fig2-panelA-network-weights-------------------------------------
#Neural net weights
...
## ----results2-fig2-panelA-network-text----------------------------------------
...
## ----results2-fig2-panelA-input-labels----------------------------------------
...
## ----results2-fig2-panelA-input-matrix----------------------------------------
#Input data matrix
...
## ----results2-fig2-panelA-input-text------------------------------------------
...
## ----results2-fig2-panelB-network-nodes---------------------------------------
#Neural net nodes
...
## ----results2-fig2-panelC-heatmap-processing----------------------------------
...
## ----results2-fig2-panelC-heatmap-base----------------------------------------
...
fig2_heatmap_ggplot <- pheatmap(matSim_H88M67_MLP_mean,
                                ...
                                filename = file.path(pathMLP, 'Rplots.pdf')) %>% 
  as.ggplot()


## ----results2-fig2-panelC-heatmap-matrix--------------------------------------
...
## ----results2-fig2-panelC-heatmap-legend--------------------------------------
#Legend scale
...
## ----results2-fig2-panelC-heatmap-mouselabs-----------------------------------
#Mouse label text
...
## ----results2-fig2-panelC-heatmap-humanlabs-----------------------------------
#Human label text
...
## ----results2-fig2-panelC-heatmap-title---------------------------------------
...
for (i in 1:length(start)) {
  write_csv(x = fig2_data[start[i]:end[i],],
            file = file.path(pathMLP, str_c("Figure2_Data", i, ".csv")))
}


## ----results2-fig2-grob, fig.width=10, fig.height=6.4-------------------------
...
## ----results2-fig2-pdf--------------------------------------------------------
pdf(file = file.path(pathMLP, "Figure2.pdf"),
    width = fig2_width,
    height = fig2_height)
...
## ----results2-fig2-write------------------------------------------------------
#Save figure 2 grob
fileout <- file.path(pathMLP, "Figure2.RData")
save(fig2_grob,
     fig2_width,
     fig2_height,
     file = fileout)
